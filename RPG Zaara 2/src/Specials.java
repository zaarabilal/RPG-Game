...
public class Specials{
	...
	public Specials(int xV, int yV, int width, int height,ImageIcon i, int dxs) {
		x=xV;
		y=yV;
		w=width;
		h=height;
	...
	public Specials(int xV, int yV, int width, int height,ImageIcon i) {
		x=xV;
		y=yV;
		w=width;
		h=height;
...
public void setdx(int dxvalue) {
	...
	public void drawSpecial(Graphics g2d) {
		g2d.drawImage(img.getImage(), x, y, 200,200,null);
	}
